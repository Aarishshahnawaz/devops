          ...
          <div className="p-10 bg-primary-50 dark:bg-primary-900/20 flex flex-col justify-between">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-300 mb-8">
                ll to reach out through any of these channels. I'm always eager to discuss new projects and opportunities.
              </p>
              ...
              <div className="space-y-6">
                <ContactMethod 
                  icon={MapPin} 
                  title="Location" 
                  detail="Aliagh, Uttar Pradesh" 
                />
                <ContactMethod 
                  icon={Mail} 
                  title="Email" 
                  detail="aarishaps2003@gmail.com"
                  link="mailto:aarishaps2003@gmail.com"
                />
                <ContactMethod 
                  icon={Phone} 
                  title="Phone" 
                  detail="+91-8630181113"
                  link="tel:+918630181113"
                />
              </div>
            </div>
